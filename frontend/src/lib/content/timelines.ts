...
const TIMELINES_DATA: Timeline[] = [
  {
    ...
    description: 'From Apsara (1956), Asia\'s first research reactor, to a declared nuclear-weapons state with 25 reactors across 7 sites — India\'s nuclear arc spans strategic defiance, technological indigenisation, and fitful integration into the global non-proliferation order.',
    events: [
  ...
  },
  {
    ...
    events: [
      ...
      { date: '2024 (Planned)', title: 'Second Uncrewed Test (Pending)', description: 'TV-D2 is planned to validate crew module reentry from 120 km altitude, drogue and main parachute sequences, and splashdown recovery from the Bay of Bengal.' },
  ...
  },
  {
    ...
    description: 'From Aadhaar to UPI to IndiaAI — Digital India represents one of the world\'s most ambitious state-led digital transformations. 138 Cr Aadhaar IDs, ~2,000 Cr monthly UPI transactions (2025), and 6.4 Lakh km of optical fibre have reshaped governance, finance, and identity for 1.4 B people.',
    events: [
      ...
      { date: '2016', title: 'UPI Launch', description: 'Unified Payments Interface (UPI) goes live — a real-time, interoperable, zero-MDR payment system. By 2025, UPI processes ~2,000 Cr monthly transactions worth ₹20+ Lakh Cr.' },
      ...
      { date: 'Dec 2019', title: 'Data Protection Bill', description: 'India introduces the Personal Data Protection Bill (revised as DPDP Act 2023) to regulate digital privacy, data processing, and cross-border flows — creating India\'s first comprehensive data governance law.' },
      { date: 'Oct 2022', title: '5G Rollout', description: 'Jio and Airtel launch 5G services within 3 months of spectrum auction; India achieves 250M+ 5G subscribers by 2025 — the fastest rollout globally.' },
      { date: '2025', title: 'IndiaAI Mission', description: 'Government launches IndiaAI Mission with ₹10,372 Cr — procuring 38,000+ GPUs, developing Indic-language foundational models, and training 500,000 AI professionals.' },
    ],
  },
  {
