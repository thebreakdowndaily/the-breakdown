...
export const ENTITIES: KnowledgeEntity[] = [
  ...
  },
  {
    ...
    description: 'Centre-right ruling coalition — 293–313 Lok Sabha seats in 2024, expanded after 2026 TMC defections',
    details: 'The National Democratic Alliance (NDA) is the ruling coalition of centre-right political parties led by the Bharatiya Janata Party (BJP). The NDA won 293–313 Lok Sabha seats in the 2024 general election. In 2026, its majority expanded after 20 of 28 TMC Lok Sabha MPs defected to the alliance, marking the largest cross-floor realignment since 2014.',
  ...
  },
  {
    ...
    type: 'Country',
    name: 'United Kingdom',
    description: 'India\'s second-largest FDI source — £36B bilateral trade, FTA signed July 2025',
    details: 'The United Kingdom is India\'s second-largest source of foreign direct investment (cumulative $35 billion) and signed a Comprehensive Economic Partnership Agreement (CEPA) with India in July 2025. Bilateral trade reached £36 billion in FY26. The UK-India Living Bridge — 1.8 million people of Indian origin — drives services trade in fintech, IT, and pharmaceuticals.',
    relatedIds: ['india'],
  },
]
